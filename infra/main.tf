...
# ------------------------------
# Recursos y variables dependientes de dominio deshabilitados temporalmente para pruebas
# sin un dominio personalizado. Descomenta cuando necesites habilitar HTTPS y CloudFront.
# ------------------------------
...
#   logging_config { include_cookies = false  bucket = null }
# }
#
